...
<b>1.0d3</b> Added Tcl API workflow::case::delete ; fixed bug
in PL/SQL implementation of
workflow_case.delete/workflow_case__delete ; added \@see to
workflow::case::insert.</li><li>
<b>1.0d2</b> Completed package developer's guide. Added
-action_id switch to workflow::case::get_activity_html.</li><li>
<b>1.0d1</b> Bumped up the version number to 1.0 to reflect the
...
possible to define this link.</li><li>Add workflow variants, so you can ship your application with
