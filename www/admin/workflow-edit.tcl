...
db_multirow -extend {edit_url delete_url} get_states get_states {} {
    set edit_url "state-ae?[export_vars -url {state_id workflow_id}]"
...
db_multirow -extend {edit_url delete_url} get_roles get_roles {} {
    set edit_url "role-ae?[export_vars -url {role_id workflow_id}]"
    workflow::role::get \
	     -role_id $role_id \
	    -array "role_info"
...
set wf_meta_edit "workflow-ae?[export_vars -url {workflow_id}]"
set add_role_url "role-ae?[export_vars -url {workflow_id}]"
set add_state_url "state-ae?[export_vars -url {workflow_id}]"
set add_action_url "action-ae?[export_vars -url {workflow_id}]"
